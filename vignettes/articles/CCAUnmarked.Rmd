...
<!-- pika survey image -->
```{r,eval=FALSE, echo=FALSE, out.width='50%', out.extra='style="float:left; padding:10px"'}
knitr::include_graphics('./art_image/timtemp.png')
``` 
---
