---
title: "Long-Format Nimble Demonstration"
author: "Tim Lyons"
...
This is example code for running Nimble the long way-it lets you check your initial values before compiling to avoid the Nimble equivalent of  JAGS's "Node inconsistent with parents" or other errors like that.


This assumes you have already created appropriate data, constant, and inital value objects and functions.

TBD:A more comprehensive walk through
